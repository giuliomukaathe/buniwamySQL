"""
Django settings for buniwa project.
...
WSGI_APPLICATION = 'buniwa.wsgi.application'
...
STATIC_URL = 'static/'
STATICFILES_DIRS = [
    os.path.join(BASE_DIR, 'buniwa/static')
]
...
EMAIL_PORT = 587
EMAIL_USE_TLS = True
EMAIL_HOST_USER = 'reachbuniwa@gmail.com'
EMAIL_HOST_PASSWORD = 'pjlwuttvdnwbwkzu'
